...
class RecipeDetailScreen extends StatefulWidget {
  ...
  RecipeDetailScreen({this.recipeID, this.recipe});
...
class RecipeDetailScreenState extends State<RecipeDetailScreen> with TickerProviderStateMixin {
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Text(
                        recipeData!.recipes!.title.validate(),
                        style: boldTextStyle(size: 26, height: 1.2),
                  ...
                  Column(
                    children: [
                      Row(
                        children: [
                          Text('${language!.difficulty}', style: boldTextStyle()).expand(),
                          8.width,
                          Text(recipeData!.recipes!.difficulty.validate(), style: primaryTextStyle()).expand(),
                        ],
                      ),
                      8.height,
                      Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(language!.dishTypeData, style: boldTextStyle()).expand(),
                          8.width,
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: recipeData!.recipes!.dish_type.validate().split(',').map((e) {
                              return Text(e, style: primaryTextStyle(), maxLines: 1, overflow: TextOverflow.ellipsis);
                            }).toList(),
                          ).expand(),
                        ],
                      ),
                      ...
                      Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(language!.cuisineData, style: boldTextStyle()).expand(),
                          8.width,
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            mainAxisAlignment: MainAxisAlignment.start,
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      ...recipeData!.recipes!.ingredients!.map((e) {
                        return Row(
                          children: [
                            Text('${e.amount.validate()}   ${e.unit.validate()}', style: primaryTextStyle(), maxLines: 2).expand(),
                            Text(e.name!, style: primaryTextStyle(), maxLines: 1, overflow: TextOverflow.ellipsis).expand(flex: 1),
                          ],
                        ).paddingOnly(top: 8);
                      }).toList(),
                      32.height,
                  ...
                  16.height,
                  Divider(color: grey, height: 0),
                  16.height,
                  if (isMobile) StartCookingWidget(recipeStepData: recipeData!.steps),
                  16.height,
                  ...
                  ).paddingOnly(left: 16, right: 16, bottom: 40, top: 16)
                ],
              ),
            ),
          ),
